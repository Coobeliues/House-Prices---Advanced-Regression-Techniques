...
Ооо, другой базар
При сабмите в каггл, показали те же результаты
...
В заключение отмечу, что в ходе анализа было протестировано несколько регрессионных моделей, каждая из которых имеет свои особенности и подходит для разных типов данных. 
...
В целом, несмотря на разнообразие моделей и методов предварительной обработки, большинство из них показали хорошие результаты. Существует интерес к дальнейшим исследованиям и тестированию других методов кодирования, предобработок, моделей и тд и тп.
